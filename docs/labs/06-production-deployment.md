# Lab 14-06 — Production Deployment

**Module:** 14 — OpenKM document management system  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-14-06.sh  
**Compose File:** docker/docker-compose.production.yml

## Objective

Deploy openkm in production with HA, monitoring, backup, and DR.

## Prerequisites

- Labs 14-01 through 14-05 pass
