# Lab 14-05 — Advanced Integration

**Module:** 14 — OpenKM document management system  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-14-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect openkm to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 14-01 through 14-04 pass
